        ...
        <div className='dashboard-content shadow-xl '>
          ...
          <div className='basis-1/4 ml-24'>
              ...
              <div className='basis-1/4 ml-24'>
                ...
                <p className='text-gray-600 mt-4 delay-[200ms] duration-[600ms]' data-aos="fade-up">Weekly</p>
              </div>
              <div className='basis-1/4 ml-24'>
                <div className='circle-menu w-12 h-12 shadow-xl flex items-center justify-center delay-[300ms] duration-[600ms]' data-aos="fade-down">
                  <span className=''> <FontAwesomeIcon icon={faCalendarDays} className='text-white' /></span>
                </div>
                <p className='text-gray-600 mt-4 delay-[200ms] duration-[600ms]' data-aos="fade-up">Monthly</p>
              </div>
              <div className='basis-1/4 ml-24'>
                <div className='circle-menu w-12 h-12 shadow-xl flex items-center justify-center delay-[300ms] duration-[600ms]' data-aos="fade-down">
