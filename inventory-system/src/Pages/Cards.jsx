...
const Cards = () => {
  ...
  return (
    <div className='card-container flex sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-12 delay-[500ms] duration-[600ms] mr-14 ml-20 mt-1   px-18' data-aos="fade-up">
    ...
    <div key={index} className='card mt-8 shadow-2xl  rounded-lg relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-between  h-40 w-48'>
        <div>
          ...
          <h1 className='text-4xl font-bold text-white mb-4'>{countupNumbers[index]}</h1>
